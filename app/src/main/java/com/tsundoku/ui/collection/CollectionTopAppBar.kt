...
fun CollectionTopAppBar(
    ...
    if (!searchingState) CollectionDefaultTopAppBar(viewerViewModel, collectionViewModel)
    else CollectionSearchBar(collectionViewModel)
}
    ...
    TopAppBar(
        ...
        actions = {
            TextField(
                ...
                modifier = Modifier.weight(1f).padding(20.dp, 0.dp, 20.dp, 10.dp),
                textStyle = TextStyle(
                    fontSize = 15.sp,
                    fontWeight = FontWeight.Bold,
                    fontFamily = interFont
